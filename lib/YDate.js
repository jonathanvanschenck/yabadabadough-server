...
module.exports = class YDate {
    ...
    end_of_month() {
        return new this(this._date.endOf('month').startOf('day'));
    }

    start_of_month() {
        return new this(this._date.startOf('month').startOf('day'));
    }

    start_of_next_month() {
        return new this(this._date.startOf('month').add(1, 'month').startOf('day'));
    }
    ...
    offset_days(days) {
        ...
        return new this(this._date.add(days, 'day').startOf('day'));
    }
